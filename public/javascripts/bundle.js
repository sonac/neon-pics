...
var _PicsPair = __webpack_require__(30);
...
var PicCompare = function (_Component) {
  _inherits(PicCompare, _Component);

  function PicCompare(props) {
    _classCallCheck(this, PicCompare);

    var _this = _possibleConstructorReturn(this, (PicCompare.__proto__ || Object.getPrototypeOf(PicCompare)).call(this, props));
    ...
    value: function componentDidMount() {
      ...
      fetch('/api/pictures').then(function (response) {
        ...
        return _this2.setState(function (state) {
          return { urls: urls, isLoading: false };
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        isLoading ? _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: urls[0], alt: 'First pic' }),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement('img', { src: urls[1], alt: 'Second pic' })
        )
      );
    }
  }]);
