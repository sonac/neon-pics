...
class ComparisonActionBuilder @Inject()(messagesApi: MessagesApi, playBodyParsers: PlayBodyParsers)
  ...
  extends ActionBuilder[ComparisonRequest, AnyContent] {
  type ComparisonRequestBlock[A] = ComparisonRequest[A] => Future[Result]

  override def parser: BodyParser[AnyContent] = playBodyParsers.anyContent

  override def invokeBlock[A](request: Request[A], block: ComparisonRequest[A] => Future[Result]): Future[Result] = {
